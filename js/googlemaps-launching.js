// Function for displaying the launching spots map on the launching spots page

function initializeMap() {

  // Set Google Maps options
  // These specific to the launching spots page of the site
  ...
  // Add the launching spots mapping data to the map
